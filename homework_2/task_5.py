...
print(f'Результат первого условия (сортировка не создавая новый список):\n{prices_in_string(numbers)}'
      f'\n---------')
...
print(f'Результат второго условия (сортировка в обратном порядке создав новый список):'
...
max_price.sort()
print(f'Результат третьего условия (вывести 5 топ цен):\n{prices_in_string(max_price)}\n---------')


# оставил кусок первоначального кода когда сделал первое задание и первое условие, чтоб показать,
